...
const file_calculator_proto_rawDesc = "" +
	...
	"\x01b\x18\x02 \x01(\x01R\x01b\"\x1e\n" +
	"\x06Result\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x01R\x05value2\xdd\x01\n" +
	"\n" +
	"Calculator\x12/\n" +
	"\x03Add\x12\x14.calculator.Operands\x1a\x12.calculator.Result\x124\n" +
	"\bSubtract\x12\x14.calculator.Operands\x1a\x12.calculator.Result\x124\n" +
	"\bMultiply\x12\x14.calculator.Operands\x1a\x12.calculator.Result\x122\n" +
	"\x06Divide\x12\x14.calculator.Operands\x1a\x12.calculator.ResultB\x0eZ\f./calculatorb\x06proto3"
...
var file_calculator_proto_depIdxs = []int32{
	...
	0, // 1: calculator.Calculator.Subtract:input_type -> calculator.Operands
	0, // 2: calculator.Calculator.Multiply:input_type -> calculator.Operands
	0, // 3: calculator.Calculator.Divide:input_type -> calculator.Operands
	1, // 4: calculator.Calculator.Add:output_type -> calculator.Result
	1, // 5: calculator.Calculator.Subtract:output_type -> calculator.Result
	1, // 6: calculator.Calculator.Multiply:output_type -> calculator.Result
	1, // 7: calculator.Calculator.Divide:output_type -> calculator.Result
