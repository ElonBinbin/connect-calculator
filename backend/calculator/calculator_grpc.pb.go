...
type CalculatorClient interface {
	...
	Subtract(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Result, error)
	Multiply(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Result, error)
...
func (c *calculatorClient) Subtract(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Result, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Result)
...
func (c *calculatorClient) Multiply(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Result, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Result)
...
func (c *calculatorClient) Divide(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Result, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Result)
...
type CalculatorServer interface {
	...
	Subtract(context.Context, *Operands) (*Result, error)
	Multiply(context.Context, *Operands) (*Result, error)
...
func (UnimplementedCalculatorServer) Subtract(context.Context, *Operands) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Subtract not implemented")
}
func (UnimplementedCalculatorServer) Multiply(context.Context, *Operands) (*Result, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Multiply not implemented")
}
func (UnimplementedCalculatorServer) Divide(context.Context, *Operands) (*Result, error) {
...
func _Calculator_Subtract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Subtract(ctx, req.(*Operands))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calculator_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Multiply(ctx, req.(*Operands))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Calculator_Divide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Divide(ctx, req.(*Operands))
	}
	return interceptor(ctx, in, info, handler)
}
